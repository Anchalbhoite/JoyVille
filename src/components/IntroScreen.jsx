...
const Intro = () => {
  ...
  return (
    <div className="text-center max-w-2xl">
      ...
      <p className="text-lg mb-4">Meet our cheerful friends:</p>
      ...
      <p className="mb-6">
        🎯 Along the way, you'll meet fun challenges, solve puzzles, and become a
        Sentiment Hero! 🦸‍♂️🦸‍♀️
      </p>
      ...
      <button
        ...
        className="ml-4 px-6 py-2 bg-blue-500 text-white font-bold rounded-xl shadow-lg hover:scale-105 transition"
      >
        🎮 Play Mini Games
      </button>
    </div>
